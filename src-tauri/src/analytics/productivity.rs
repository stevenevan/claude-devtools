...
pub fn compute_productivity_metrics(days: u32) -> Result<ProductivityMetrics, String> {
    ...
    for project in &projects {
        ...
        for entry in entries {
            ...
            let modified_at = entry
                ...
                .unwrap_or(0.0);
            // Go has no portable birthtime; it uses mtime as created (productivity.go:140).
