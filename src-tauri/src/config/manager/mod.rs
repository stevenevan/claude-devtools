...
use super::triggers;
use super::types::{
    AppConfig, ClaudeRootInfo, HiddenSession, NotificationTrigger, PinnedSession,
};
...
mod merge_helpers;
use merge_helpers::{
    load_config_from_disk, merge_json_into_display, merge_json_into_general,
    merge_json_into_http_server, merge_json_into_notifications, merge_json_into_ssh,
    merge_trigger_updates, now_millis, resolve_config_path,
};
