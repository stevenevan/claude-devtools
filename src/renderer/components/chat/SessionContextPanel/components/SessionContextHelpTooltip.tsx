  ...
  return (
    <Popover>
      <PopoverTrigger aria-label="Help: Visible Context">
        <HelpCircle
          size={14}
          className="text-muted-foreground cursor-help transition-colors hover:opacity-80"
        />
      </PopoverTrigger>
      <PopoverContent align="end" className="w-72 p-3">
        <div className="space-y-3 text-xs">
          <div>
            <div className="text-foreground mb-1 font-semibold">What is Visible Context?</div>
          ...
          <div>
            ...
            <div className="text-muted-foreground space-y-2 leading-normal">
              ...
              <div className="flex">
                <span className="text-muted-foreground min-w-[74px] text-left">Visible:</span>
                <span className="flex-1 leading-snug">
          ...
          <div>
            <div className="text-foreground mb-1 font-semibold">Optimization Tips</div>
            <ul className="text-muted-foreground space-y-1 pl-3 leading-normal">
