...
interface TooltipRenderPayloadItem {
...
function ChartTooltipContent({
  ...
  React.ComponentProps<'div'> & {
    active?: boolean;
    payload?: TooltipRenderPayloadItem[];
    label?: unknown;
    hideLabel?: boolean;
    ...
    if (labelFormatter) {
      return (
        <div className={cn('font-medium', labelClassName)}>
          {(labelFormatter as (l: unknown, p: unknown) => React.ReactNode)(value, payload)}
        </div>
      );
    }
...
interface LegendRenderPayloadItem {
  value?: string | number;
  dataKey?: string | number;
  type?: string;
  color?: string;
...
function ChartLegendContent({
  ...
  payload?: LegendRenderPayloadItem[];
