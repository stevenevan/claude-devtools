...
export const SELECT_INPUT_BASE =
  'rounded-sm border border-border bg-transparent px-2 py-1 text-sm text-text focus:border-transparent focus:outline-hidden focus:ring-1 focus:ring-indigo-500';
